// The shared Axios client (single instance, CSRF request interceptor,
// 401-redirect response interceptor) and the hostname detector now live
// in ./api/client. This file keeps the domain endpoint functions during
// the Phase 4 split; they all call the shared `api` instance. The
// `isSalesSubdomain` re-export preserves the historical
// `services/api` import specifier for existing consumers.
import api, { isSalesSubdomain } from './api/client'

export { isSalesSubdomain }
